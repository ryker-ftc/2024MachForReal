...
public class RobotContainer {
  ...
  private final JoystickButton m_GroundIntakeButton = new JoystickButton(driver2, XboxController.Button.k.value);
  ...
  private void configureButtonBindings() {
    ...
    rightTrigger.whileTrue(new RunCommand(() -> s_Conveyor.groundOuttake()));
